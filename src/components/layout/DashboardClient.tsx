    ...
    return (
        ...
        <div className="flex h-[100dvh] w-full overflow-hidden bg-slate-50 font-sans selection:bg-[#004B87]/20 relative">
            ...
            <div className="flex flex-1 flex-col min-w-0 h-full relative">
                ...
                {/* 
                    CONTENEDOR SCROLLABLE (El arreglo principal)
                    overflow-y-auto maneja el scroll aquí, mientras que el main interno
                    ya no tiene la altura bloqueada.
                */}
                <div className="flex-1 overflow-y-auto overflow-x-hidden bg-slate-50/50 custom-scrollbar relative">
                    {/* Se eliminaron h-full y min-h-full. Se agregó max-w-[1600px] para que en monitores ultra anchos no se deforme el contenido */}
                    <main className="flex flex-col w-full mx-auto transition-all duration-300">
                        {children}
                    </main>
                </div>
            </div>
